      ...
      highlight_overrides = {
        macchiato = function(macchiato)
          return {
            ...
            ["LspReferenceRead"] = { bg = macchiato.surface1 },
            ...
            ["Normal"] = { bg = "none" },
            ["FloatBorder"] = { bg = "none" },
            ["AvantePromptInput"] = { bg = "none" },
            ["AvantePromptInputBorder"] = { bg = "none" },
            ["NormalFloat"] = { bg = "none" },
            ...
            ["DiagnosticInfo"] = { fg = macchiato.blue },
            ["DiagnosticUnderlineInfo"] = { sp = macchiato.blue },
            ["DiagnosticSignInfo"] = { fg = macchiato.blue },
            ["DiagnosticHint"] = { fg = macchiato.green },
            ["NonText"] = { fg = macchiato.blue },
            ["SnippetTabstop"] = { bg = "none" },
            ["@property"] = { fg = macchiato.blue },
          }
        end,
      },
    },
